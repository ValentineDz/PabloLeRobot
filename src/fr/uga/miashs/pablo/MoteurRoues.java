...
public class MoteurRoues {
	...
	public MoteurRoues(String vitesse) {
		...
		this.roue1 = WheeledChassis.modelWheel(portRoue1, 56).offset(-70); // obtenir le diametres des roues / la
	...
	public void tourner(double distance) {
		
		pilot.rotate(-distance, false);
	}
